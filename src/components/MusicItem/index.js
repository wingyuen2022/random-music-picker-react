...
function MusicItem({isList, curSong, musicList, setMusicList}) {
  ...
  return (
    <>
      ...
      <td><iframe src={curSong.musicUrl} className="player" hidden={(curSong.id===undefined)}></iframe></td>
      <td><a href="#" onClick={addSong} className="anchor" hidden={isList || curSong.id === undefined}><h1>[ADD]</h1></a></td>
